...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    general: '通用',
    settingsTabApp: '应用',
    settingsTabModels: '模型与 API',
    settingsTabCowork: 'Cowork',
    settingsTabIntegrations: '集成',
    settingsTabAbout: '关于',
    coworkSectionEngine: '引擎',
    coworkSectionMemory: '记忆',
    coworkSectionPersona: '人设与档案',
    integrationsImSectionTitle: 'IM 机器人',
    integrationsImSectionDescription: '连接即时通讯网关与机器人配置。',
    integrationsEmailSectionTitle: '邮件技能',
    integrationsEmailSectionDescription: '配置邮件相关技能与账户。',
    model: '模型',
    shortcuts: '快捷键',
    about: '关于',
    aboutVersion: '版本',
    ...
    authQuotaExhausted: '今日免费额度已用完。您可以登录 YuanAI Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    coworkWorkingDirectoryHint: 'YuanAI 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 YuanAI 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 YuanAI 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'YuanAI 使用模型设置中的当前模型与提供商配置。',
    ...
    coworkAgentEngineOpenClawHint: '小龙虾',
    coworkAgentEngineClaudeLegacy: '龙虾',
    ...
    coworkConfigSaveFailed: '保存 YuanAI 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: 'YuanAI 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: 'YuanAI 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    coworkWelcome: '打造AI时代的超级个体',
    delete: '删除',
    coworkDescription: '开始养一只你的“虾”',
    ...
    agentsPresetInLobsterPond: '官方预制龙虾已统一放在侧栏「虾池」。本页仅管理你创建的自定义智能体。',
    goToLobsterPond: '前往虾池',
  customCreate: '自定义创建',
    choosePreset: '选择预设',
    ...
    // 隐私协议弹窗
    privacyDialogTitle: '网易有道YuanAI服务协议',
    privacyDialogDesc: '在使用网易有道YuanAI之前，请您仔细阅读{link}内容，并进行确认。',
    privacyDialogLinkText: '网易有道YuanAI服务协议',
  ...
  en: {
    ...
    general: 'General',
    settingsTabApp: 'App',
    settingsTabModels: 'Models & API',
    settingsTabCowork: '引擎',
    settingsTabIntegrations: 'Integrations',
    settingsTabAbout: 'About',
    coworkSectionEngine: 'Engine',
    coworkSectionMemory: 'Memory',
    coworkSectionPersona: 'Persona & profile',
    integrationsImSectionTitle: 'IM bot',
    integrationsImSectionDescription: 'Gateway and bot configuration for instant messaging.',
    integrationsEmailSectionTitle: 'Email skill',
    integrationsEmailSectionDescription: 'Email-related skills and account settings.',
    model: 'Model',
    shortcuts: 'Shortcuts',
    about: 'About',
    ...
    authQuotaExhausted: 'Daily free quota exhausted. Visit YuanAI Portal to purchase a plan or credits, or configure your own API Key in Settings.',
    ...
    // YuanAI
    cowork: 'YuanAI',
    coworkSettings: 'YuanAI Settings',
    ...
    coworkWorkingDirectoryHint: 'YuanAI will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for YuanAI...',
    coworkSystemPromptHint: 'Optional system prompt to customize YuanAI\'s behavior',
    ...
    coworkModelSettingsHint: 'YuanAI uses the current model and provider configuration from Model Settings.',
    ...
    coworkConfigSaveFailed: 'Failed to save YuanAI settings. Please try again.',
    ...
    coworkPermissionDescription: 'YuanAI is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: 'YuanAI needs your input',
    ...
    coworkDescription: 'Build the super individual in the age of AI',
    ...
    agentsPresetInLobsterPond: 'Official preset lobsters are in the sidebar under Lobster Pond. This page is only for your custom agents.',
    goToLobsterPond: 'Open Lobster Pond',
  customCreate: 'Custom Create',
    ...
    // Privacy dialog
    privacyDialogTitle: 'NetEase Youdao YuanAI Terms of Service',
    privacyDialogDesc: 'Before using NetEase Youdao YuanAI, please carefully read the {link} and confirm.',
    privacyDialogLinkText: 'NetEase Youdao YuanAI Terms of Service',
