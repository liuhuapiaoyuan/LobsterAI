...
# "Calendar access permission is required. Please open System Settings > Privacy & Security > Calendar, and authorize Terminal or YuanAI"
```
...
```
**Solution:** Open System Settings > Privacy & Security > Calendar, authorize Terminal or YuanAI
