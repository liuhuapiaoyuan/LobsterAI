...
This guide walks through testing the entire Web Search Skill integration with YuanAI.

## Prerequisites

1. YuanAI built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with YuanAI.

**Steps:**

1. Start YuanAI in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of YuanAI launch.
...
1. Open a terminal while YuanAI is running
...
**Objective:** Verify graceful shutdown of services when YuanAI quits.

**Steps:**

1. With YuanAI running and searches completed, quit the application
...
1. Start YuanAI (ensure headless is false in config)
...
- ✅ Server auto-starts with YuanAI
