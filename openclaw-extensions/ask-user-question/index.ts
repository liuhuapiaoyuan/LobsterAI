 ...
 * and waits for the user's response via an HTTP callback to YuanAI.
 *
 * This enables delete-confirmation modals on the YuanAI desktop app
...
const plugin = {
  ...
  description: 'Structured user confirmation tool for YuanAI desktop.',
  configSchema: {
  ...
  register(api: OpenClawPluginApi) {
    ...
    api.registerTool((ctx) => {
      // Only enable for YuanAI desktop sessions (sessionKey starts with 'agent:main:lobsterai:').
